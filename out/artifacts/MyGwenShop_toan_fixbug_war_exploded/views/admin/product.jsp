...
<div id="toast"></div>
<script src="/views/public/js/management/Product/getElement.js"></script>
<script src="/views/public/js/management/Product/product.js"></script>
<script src="/views/public/js/management/main.js"></script>
<script src="/views/public/js/management/Product/checkInfo.js"></script>
<script>
    let option = {
