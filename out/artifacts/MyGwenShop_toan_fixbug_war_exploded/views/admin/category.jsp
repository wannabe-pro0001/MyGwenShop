...
<div id="toast"></div>
<script src="/views/public/js/management/Category/getElement.js"></script>
<script src="/views/public/js/management/main.js"></script>
<script src="/views/public/js/management/Category/checkInfo.js"></script>
<script src="/views/public/js/management/Category/category.js"></script>
</body>
</html>
